  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 px-4" onClick={onClose}>
      <div className="relative w-full max-w-2xl rounded-2xl border border-black/10 bg-white p-6 text-zinc-900 shadow-xl" onClick={(event) => event.stopPropagation()}>
        <button className="absolute right-4 top-4 text-zinc-500 hover:text-black" aria-label="Close" onClick={onClose}>
          <IoClose size={20} />
        </button>
  ...
  return (
    <>
      ...
      <OverlayModal
        ...
        subtitle="Keep accuracy high before chasing speed."
      >
      ...
      <OverlayModal
        ...
        title="Game docs"
        subtitle="Reference for gameplay and settings"
      >
        <div>
        ...
        <div>
          ...
          <ul className="list-disc space-y-1 pl-4">
            <li><strong>Reset</strong>: clears all progress for the current snippet.</li>
            <li><strong>Change snippet</strong>: loads the next snippet in sequence.</li>
            <li><strong>Language selector</strong>: reloads snippets for the selected language or stack.</li>
          </ul>
        </div>
      ...
      <div className="rounded-3xl border border-black/10 bg-white p-6 shadow-sm">
        <header className="flex flex-col gap-4 border-b border-black/5 pb-4 md:flex-row md:items-center md:justify-between">
          <div>
            <p className="text-xs uppercase tracking-[0.4em] text-zinc-500">Code typer</p>
